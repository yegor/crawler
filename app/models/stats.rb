  ...
  class << self
    ...
    def raking_over_time(options = {})
      ...
      results = ChartSnapshot
        .select("featurings.type as featuring_type, pages.type as page_type, game_snapshots.rank as rank, meta_data.release_date as release_date, meta_data.new_version as new_version, meta_data.game_id as game_id, chart_snapshots.chart_id as chart_id, chart_snapshots.created_at as date")
